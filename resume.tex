...
\newcommand{\jobheader}[2]{%
  \noindent
  \begin{tabular}[t]{@{}>{\raggedright\arraybackslash}p{\jobtitlewidth}@{}>{\raggedleft\arraybackslash}p{\jobdateswidth}@{}}
  #1 & \textbf{#2}
  \end{tabular}\par
}
...
\begin{jobentry}{\textbf{Buck (build tool)} (https://buck.build)}{2016}
  \begin{itemize} \itemsep -2pt
