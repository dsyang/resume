...
% Extra breathing room above each section title (default is 1.6ex).
\sectionskip=3.2ex plus 1ex minus -.2ex
...
\begin{jobentry}{\textbf{Software Engineer - Mobile}: Notion, San Francisco, CA}{2026 - Present}
  \begin{itemize}
      \item Shipped push notifications for agent messages on iOS Notion Core and Notion Agents app.
      \item Refactored search feature on Android to use Circuit presenter patterns.
      \item Improved bug report investigations by embedding session ID into Android app screenshots.
  \end{itemize}
\end{jobentry}

\begin{jobentry}{\textbf{Engineering Manager - Mobile Product}: Notion, San Francisco, CA}{2024 - 2026}
  \begin{itemize}
      ...
      \item Supported iOS and Android engineers across NY and SF offices. Grew team from 4 to 10.
  \end{itemize}
\end{jobentry}

\begin{jobentry}{\textbf{Software Engineer - Android}: Notion, San Francisco, CA}{2022 - 2024}
  \begin{itemize}
...
\begin{jobentry}{\textbf{Software Engineer}: Instagram, San Francisco, CA}{2019 - 2022}
  \begin{itemize}
      \item Tech led Android client infrastructure projects for Direct Messaging to support cross-app communication.
  \end{itemize}
\end{jobentry}

\begin{jobentry}{\textbf{Engineer in Residence}: Facebook, Seaside, CA}{2019}
  \begin{itemize}
...
\begin{jobentry}{\textbf{Software Engineer}: Facebook, Menlo Park, CA}{2014 - 2018}
  \begin{itemize}
...
\begin{jobentry}{\textbf{code.imdaniel.fyi} (https://code.imdaniel.fyi)}{2026}
  \begin{itemize}
    \item Collection of small HTML utilities and games, with Android and iOS apps to use them offline.
    \item An exercise in building and shipping products entirely from a phone using the Claude and GitHub mobile apps.
  \end{itemize}
\end{jobentry}

\begin{jobentry}{\textbf{readcode} (https://github.com/dsyang/readcode)}{2026}
  \begin{itemize}
    \item Code review desktop app for commenting across multiple commits and making manual edits. Built with Rust + Tauri to review and tweak AI-generated code without an IDE.
  \end{itemize}
\end{jobentry}
