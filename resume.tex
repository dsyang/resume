...
\textwidth=5.85in % increase textwidth to get smaller right margin
\begin{document}
...
\textbf{Notion}: Software Engineer - Mobile, San Francisco, CA \hfill \textbf{2026 - Present}
  \begin{itemize}
      ...
      \item Drove an EPD onboarding revamp to update session format and content to better fit agentic engineering era.
  \end{itemize}
