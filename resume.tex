...
\textbf{Notion}: Engineering Manager - Mobile Product, San Francisco, CA \hfill \textbf{2024 - 2026}
  \begin{itemize}
      \item Defined mobile strategy and product direction with input from tech leads,
        \\ product managers, designers, and other engineering managers.
      \item Shifted team direction in 2025 to support Notion Agents natively,
        \\ launch doubled mobile AI users and usage.
      \item Grew team from 4 to 10 engineers across NY and SF.
  \end{itemize}
...
\textbf{Notion}: Software Engineer - Android, San Francisco, CA \hfill \textbf{2022 - 2024}
  \begin{itemize}
      \item Productionized Notion's "native-first" strategy by
        \\ optimizing Jetpack Compose scroll performance and other launch-blockers ahead of native home tab launch.
      ...
      \item Led iOS \& Android engineers to rebuild Notifications tab.
        \\ Built API endpoint to centralize and share business logic between platforms.
  \end{itemize}
