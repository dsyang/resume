...
% Bullet text wraps to a narrower column than the title/date header row,
% so job entry lines stay short and easy to read even though the header
% has the full width available for longer titles.
\newlength{\jobbodywidth}
\setlength{\jobbodywidth}{\jobtitlewidth}
\addtolength{\jobbodywidth}{-0.9in}
...
\newenvironment{jobentry}[2]{%
  ...
  \begingroup
  \hsize=\jobbodywidth
  \linewidth=\jobbodywidth
  \textwidth=\jobbodywidth
  \tolerance=9999
